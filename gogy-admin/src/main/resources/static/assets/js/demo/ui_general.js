...
$(document).ready(function() {
    ...
    var a = $("body")[0].style;
    $("#colorpicker-event").colorpicker().on("changeColor",
        function(b) {
                ...
                bootbox.dialog({
                    ...
                    buttons: {
                        danger: {
                            ...
                            className: "btn-danger",
                            callback: function() {
                                bootbox.alert("Aww boo. Click the button below to get rid of all these popups.",
                                    function() {
                                        bootbox.hideAll()
                                    })
                            }
                        ...
                        success: {
                            ...
                            className: "btn-success",
                            callback: function() {
                                bootbox.alert("Glad to hear it! Click the button below to get rid of all these popups.",
                                    function() {
                                        bootbox.hideAll()
                                    })
                            }
